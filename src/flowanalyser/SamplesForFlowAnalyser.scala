...
"""
    ...
    val f1 = FlowAnalyser.isReachable(SParsers.parsePat("False()"), RuleName("R0"), tg)
    val f2 = FlowAnalyser.isReachable(SParsers.parsePat("True()"), RuleName("R0"), tg)
